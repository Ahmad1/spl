 ...
 */
public class FloatLabelUtil extends LinearLayout {
        private static final String TAG = "FloatLabelUtil";

        private static long ANIMATION_DURATION = 500;
        private static int HINT_DEFAULT_COLOR = 0xFF006363;
        private static final int HINT_DEFAULT_COLOR_DISABLED = 0xFF999999;
        ...
        public FloatLabelUtil(Context context) {
            this(context, null);
        }

        public FloatLabelUtil(Context context, AttributeSet attrs) {
            super(context, attrs);
            ...
            TypedArray array = context.obtainStyledAttributes(attrs,
                    R.styleable.FloatLabelUtil, 0, 0);
            String hint = array
                    .getString(R.styleable.FloatLabelUtil_editText_hint);
            mHintColor = array.getColor(
                    R.styleable.FloatLabelUtil_editText_color,
                    HINT_DEFAULT_COLOR);
            float size = array
                    .getDimension(R.styleable.FloatLabelUtil_editText_size,
                            HINT_DEFAULT_SIZE);
